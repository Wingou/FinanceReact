  ...
  return (
    <thead>
      <tr key='tr_header'>
        ...
        {isColDateCreate && isColObj && <th key='th_dateCreate' className='thDateCreate'> DATE<br />CREATE </th>}
        {isColDateModif && isColObj && <th key='th_dateModif' className='thDateModif'> DATE<br />MODIF </th>}
